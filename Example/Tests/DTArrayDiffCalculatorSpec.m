...
describe(@"TEArrayDiffCalculator", ^{
    describe(@"diff calculation", ^{
        ...
        context(@"objects were deleted and updated", ^{
            beforeAll(^{
                TETestUniqueModel *model = [[TETestUniqueModel alloc] initWithId:@3];
                model.name = @"name";
                
                TETestUniqueModel *updatedModel = [[TETestUniqueModel alloc] initWithId:@3];
        ...
        context(@"objects were inserted and updated", ^{
            beforeAll(^{
                TETestUniqueModel *model = [[TETestUniqueModel alloc] initWithId:@4];
                model.name = @"name";
                
                TETestUniqueModel *updatedModel = [[TETestUniqueModel alloc] initWithId:@4];
                updatedModel.name = @"name updated";
        ...
        context(@"objects were moved", ^{
            ...
            it(@"should return valid moved indexes", ^{
                ...
                [[theValue(diff1.index) should] equal:theValue(2)];
                [[theValue(diff1.fromIndex) should] equal:theValue(1)];
            });
        });
